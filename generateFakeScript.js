// TW Fake Generator - Jednorazová konfigurácia sveta
...
(function() {
  ...
  html += '<p style="margin:2px 0 0;font-size:10px;color:#8b7355;">Jednorazová konfigurácia sveta</p>';
  html += '</div>';
  ...
  document.getElementById('tw-gen-btn').onclick = function() {
    ...
    var bookmarklet = "javascript:var _twSetup='" + setupData + "';$.getScript('https://raw.githubusercontent.com/dusanG227/tw-scripts/main/fakeScriptMain.js');void(0);";
